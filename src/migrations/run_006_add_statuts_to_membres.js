...
/**
 * Script pour exécuter la migration 006: Ajout de la colonne Statuts à la table membres
 */
async function runMigration() {
  ...
  try {
    ...
    // Lire le fichier SQL
    const sqlFile = path.join(__dirname, '006_add_statuts_to_membres.sql');
    ...
    console.log('  - Colonne Statuts ajoutée à la table membres');
