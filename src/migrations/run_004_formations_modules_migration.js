...
/**
 * Script pour exécuter la migration 004: Formations, Modules, Quiz.module_id
 */
async function runMigration() {
  ...
  try {
    ...
    // Lire le fichier SQL
    const sqlFile = path.join(__dirname, '004_create_formations_and_modules.sql');
    ...
    console.log('  - Table formations créée (formations)');
    console.log('  - Table modules créée (modules)');
    console.log('  - Colonne module_id ajoutée à la table quiz avec clé étrangère et index');
